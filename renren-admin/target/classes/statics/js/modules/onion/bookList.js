...
function edit_this(obj){
    ...
    $.ajax({
        ...
        success: function (result) {
            console.log(result);
            forms[0].value=result.book.id;
            forms[1].value=result.book.name;
            forms[2].value=result.book.publisher;
            forms[3].value=result.book.writer;
            forms[4].value=result.book.translator;
            forms[5].value=result.book.classification;
            forms[6].value=result.book.uploadPeople;
            forms[7].value=result.book.updatePeople;
            forms[8].value=result.book.listOn;
            forms[9].value=result.book.createTime;
        }
    });
}
// 表格
var bookList = new Vue({
    ...
    data: {
        headers: [
            ...
            {title: '<div style="width:67px">书名</div>'},
            {title: '<div style="width:67px">出版社</div>'},
            {title: '<div style="width:67px">作者</div>'},
            {title: '<div style="width:67px">译者</div>'},
            {title: '<div style="width:67px">类型</div>'},
            {title: '<div style="width:47px">上传人</div>'},
            {title: '<div style="width:47px">修改人</div>'},
            // {title: '<div style="width:67px">责编</div>'},
            {title: '<div style="width:67px">上架状态</div>'},
            {title: '<div style="width:67px">上站时间</div>'},
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        result.page.list.forEach(function (item) {
                            ...
                            row.push(item.writer);
                            row.push(item.translator);
                            row.push(item.classificationName);
                            row.push(item.uploadPeople);
                            row.push(item.updatePeople);
                            // row.push(item.editor);
                            row.push(st.get(item.listOn));
