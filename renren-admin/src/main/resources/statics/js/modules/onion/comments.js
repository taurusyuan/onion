...
function edit_this(obj){
    ...
    $.ajax({
        ...
        success: function (result) {
            console.log(result);
            forms[0].value=result.comments.id;
            forms[1].value=result.comments.name;
            forms[2].value=result.comments.commentContent;
            forms[3].value=result.comments.commentPeople;
            forms[4].value=result.comments.approvalState;
            forms[5].value=result.comments.createTime;
        }
    });
}
...
var comments = new Vue({
    ...
    data: {
        headers: [
            ...
            {title: '<div style="width:388px">评论内容</div>'},
