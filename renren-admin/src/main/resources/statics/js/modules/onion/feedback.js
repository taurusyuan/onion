...
var edit_data = new Vue({
    ...
    methods: {
        ...
        submit: function () {
            ...
            status = 1;
            if (typeof(probeJson["userName"]) == "undefined") {
                toastr.warning("请录入用户名!");
            } else {
...
function edit_this(obj){
    ...
    $.ajax({
        ...
        success: function (result) {
            console.log(result);
            forms[0].value=result.feedback.id;
            forms[1].value=result.feedback.userName;
            forms[2].value=result.feedback.type;
            forms[3].value=result.feedback.feedback;
            forms[4].value=result.feedback.treatmentState;
            forms[5].value=result.feedback.tel;
            forms[6].value=result.feedback.createTime;
        }
    });
}
...
var feedback = new Vue({
    ...
    data: {
        headers: [
            ...
            {title: '<div style="width:67px">用户名</div>'},
            {title: '<div style="width:67px">类型</div>'},
            {title: '<div style="width:67px">意见</div>'},
            {title: '<div style="width:67px">处理状态</div>'},
            {title: '<div style="width:67px">联系方式</div>'},
            {title: '<div style="width:67px">反馈时间</div>'},
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        result.page.list.forEach(function (item) {
                            ...
                            row.push(st.get(item.treatmentState));
                            row.push(item.tel);
